...
| I4  | Type(s) of legal entity for energy communities | e.g. <ul><li>Association</li><li>Co-operative</li><li>Company</li><li>No legal entity required</li><ul>  |
| I5  | Expression/requirements for local vicinity for RECs | e.g. <ul><li>All members must be within a circle of 500m in urban areas, 2,1 km in rural areas.</li><li>Local RECs must be behind a secondary substation, for regional RECs all members must be behind the same primary substation.</li><ul>  |
| I6  | Balancing responsibility of JASCs, RECs and CECs | Describe the responsibility for staying within balance for the different schemas. E.g. JASCs, RECs and CECs are not balancing responsible (but are incentivised by reduced grid fees); e.g. RECs must be a supplier or contract their own BRP.  |
| I7  | National names of type(s) of communit(ies) mapping to Article 2 (15) of Directive (EU) 2018/2001​ | e.g. Gemeinschaftliche Erzeugungsanlagen  |
| I8  | National names of type(s) of communit(ies) mapping to Articles 16 and (22) of Directive (EU) 2018/2001​ | legal entities, whose primary objective is to provide environmental, economic or social community benefits to its members or shareholders through the development, management and operation of renewable energy projects. e.g. <ul><i>Lokale Erneuerbare Energie-Gemeinschaft</li><li>Regionale Erneuerbare Energie-Gemeinschaft</li></ul>  |
| I9  | National names of type(s) of communit(ies) mapping to Article 2(28) 16 and 22 of Directive (EU) 2019/944​​ | legal entities, whose primary objective is to provide environmental, economic or social community benefits to its members or shareholders through the development, management and operation of renewable energy projects. e.g. <ul><li>Bürgerenergiegemeinschaft</li></ul>  |
| I10  | Grid tariff incentivisation | Describe model(s) for grid tariff incentivisation. E.g. total reduction for jointly acting self-consumers or for local RECs.  |
| I11  | Process for creating an energy community | Describe the process(es) to establish an EC following the model(s) described above. Please include links to national explanatory documents/ websites if available.  |
